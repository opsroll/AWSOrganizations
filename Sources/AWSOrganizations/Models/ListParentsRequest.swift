...
open class ListParentsRequest: Codable {
    ...
    public init(childId: ChildId, maxResults: MaxResults?, nextToken: NextToken?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        childId = try container.decode(ChildId.self, forKey: "ChildId")
