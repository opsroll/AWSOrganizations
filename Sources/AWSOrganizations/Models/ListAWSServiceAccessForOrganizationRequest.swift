//
// ListAWSServiceAccessForOrganizationRequest.swift
//
...
open class ListAWSServiceAccessForOrganizationRequest: Codable {
    ...
    public init(maxResults: MaxResults?, nextToken: NextToken?) {
