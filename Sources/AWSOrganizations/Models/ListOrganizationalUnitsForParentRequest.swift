//
// ListOrganizationalUnitsForParentRequest.swift
//
...
open class ListOrganizationalUnitsForParentRequest: Codable {
    ...
    public init(maxResults: MaxResults?, nextToken: NextToken?, parentId: ParentId) {
